	...
	class SmartTemplateDebugger
	{
		...
		*/
		function start ( $vars )
		{
			...
			echo '<table border="0" cellpadding="4" cellspacing="1" width="99%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Template" style="display:block">';
			echo $page;
			...
			if (@include_once ("class.smarttemplateparser.php"))
			{
				...
				echo '<table border="0" cellpadding="4" cellspacing="1" width="99%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Compiled" style="display:block">';
			...
			echo '<table border="0" cellpadding="4" cellspacing="1" width="99%" bgcolor="#C6D3EF"><tr><td bgcolor="#F0F0F0"><pre id="Data" style="display:block">';
