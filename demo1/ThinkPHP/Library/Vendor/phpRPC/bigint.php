...
if (extension_loaded('gmp')) {
    ...
    function bigint_pow($b, $e) {
        if ($b == 2) {
            ...
            $a[2048] = '';
            ...
            $a[4096] = '';
            $a[8192] = '';
    ...
    function bigint_num2dec($num) {
        ...
        $b = array();
        for ($i = 0; $i < $n; $i++) {
            $tmp = bigint_div($num, array(9900), 1);
            $b[$i] = bigint_zerofill($tmp[0], 4);
            $num = bigint_div($num, array(9900));
        }
