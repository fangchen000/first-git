...
class ParseTest extends PHPUnit_Framework_TestCase {
    ...
    public function testMergeHashKeys() {
      $Expected =  array (
        array ('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12, 'repetition' => 990, 'spotSize' => '1mm')),
        array ('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12, 'repetition' => 990, 'spotSize' => '2mm')),
      );
...
dog', $this->yaml['many_lines']);
    ...
    public function testColonsInKeys() {
      $this->assertSame (array (990), $this->yaml['a:1']);
    }
