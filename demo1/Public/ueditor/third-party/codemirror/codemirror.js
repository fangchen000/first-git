    ...
    function CodeMirror(place, givenOptions) {
        ...
        wrapper.innerHTML =
            '<div style="overflow: hidden; position: relative; width: 3px; height: 0px;">' + // Wraps and hides input textarea
                ...
                '<div style="position: absolute; width: 99%; height: 0; overflow: hidden; visibility: hidden"></div>' +
        ...
        function updateDisplay(changes, suppressCallback) {
            ...
            var from = Math.max(visible.from - 99, 0), to = Math.min(doc.size, visible.to + 99);
        ...
        function onContextMenu(e) {
            ...
            input.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
                "px; left: " + (e.clientX - 5) + "px; z-index: 990; background: white; " +
        ...
        function matchBrackets(autoclear) {
            ...
            for (var i = head.line, e = forward ? Math.min(i + 99, doc.size) : Math.max(-1, i - 99); i != e; i+=d) {
