...
* [#9930](http://dev.ckeditor.com/ticket/9930): [IE] Fixed: Prevented "Unspecified Error" thrown in various cases when IE8-9 does not allow access to `document.activeElement`.
...
* [#9991](http://dev.ckeditor.com/ticket/9991): Blockquote should be treated like an object by the styles system. Thanks to [dan-james-deeson](https://github.com/dan-james-deeson)!
...
* [#1994](http://dev.ckeditor.com/ticket/1994): Integrated [Enhanced Image](http://ckeditor.com/addon/image2) dialog window with [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter).
...
* [#11177](http://dev.ckeditor.com/ticket/11177): Widget drag handler improvements:
  ...
  * [#1991](http://dev.ckeditor.com/ticket/1991): Fixed: Multiple synchronous layout recalculations are caused by initial drag handler positioning causing performance issues.
...
* [#9968](http://dev.ckeditor.com/ticket/9968): Fixed: Support for protocol-relative URLs.
...
* [#9955](http://dev.ckeditor.com/ticket/9955): [IE8-10] Fixed: *Delete* pressed on a selected image causes the browser to go back.
...
* [#1992](http://dev.ckeditor.com/ticket/1992): Added the [`draggable`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget.definition-property-draggable) option to disable drag and drop support for widgets.
...
* [#9928](http://dev.ckeditor.com/ticket/9928): New [`config.dialog_noConfirmCancel`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-dialog_noConfirmCancel) configuration option that eliminates the need to confirm closing of a dialog window when the user changed any of its fields.
...
* [#9904](http://dev.ckeditor.com/ticket/9904): [ChromeVox] Button names are not announced.
...
* [#9927](http://dev.ckeditor.com/ticket/9927): Separated list and block indentation into two plugins: [Indent List](http://ckeditor.com/addon/indentlist) and [Indent Block](http://ckeditor.com/addon/indentblock).
...
* [#9942](http://dev.ckeditor.com/ticket/9942): Introduced [`config.title`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-title) setting to change the human-readable title of the editor.
