...
DragListener.prototype = {
		...
		if (!this.isListening) {
			...
			if (ev && this.options.scroll) {
				...
				if (!scrollParent.is(window) && !scrollParent.is(document)) {
					...
					this.scrollHandlerProxy = debounce($.proxy(this, 'scrollHandler'), 99);
	...
	scrollIntervalFunc: function() {
		var el = this.scrollEl;
		var frac = this.scrollIntervalMs / 990; // considering animation frequency, what the vel should be mult'd by
